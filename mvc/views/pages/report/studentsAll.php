...
table tbody tr td{padding:9px 2px 9px 2px;}
  ...
  <div class="col-sm-12" style="padding:0px;margin:0px;">
    ...
    <h6 align="right" style="margin-top:1px; margin:0px;">Fecha de impresion
 : <?php echo date("d-m-Y")?></h6>
  ...
  <div class="container">
    ...
    <h4 align="center"> Informe de información del estudiante</h4>
  </div>
  <table width="100%">
    <tr>
      <td><b>Departmento : </b>
    ...
    <tbody style="font-size:11px;" >
      ...
      //      if(($dept_fill_name->dept_sort_name)==($row->teacher_department)){
         ...
         <tr>
          ...
          <td class="capitalize"><?php echo $row->std_name; ?></td>
          <td class="uppercase"><?php echo $row->std_dept; ?></td>
          <td class="uppercase"><?php echo $row->std_batch; ?></td>
          <td><?php echo $row->std_section; ?></td>
          <td><?php echo $row->required_credit; ?></td>
      ...
      <p class="note" style="font-size:10px;">RC: Crédito requerido<p>
